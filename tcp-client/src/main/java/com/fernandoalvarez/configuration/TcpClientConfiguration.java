...
public class TcpClientConfiguration {
    ...
    //para entregar los mensajes directamente al servidor en el mismo hilo de ejecución del remitente
    ...
    //recibe mensajes del servidor utilizando la conexión configurada en "clientConnectionFactory"
    @Bean
